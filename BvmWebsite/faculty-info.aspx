<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="faculty-info.aspx.cs" Inherits="BvmWebsite.faculty_info" %>
            ...
            <div class="row cols-wrapper">
                ...
                <div class="col-md-2 faculty">
                    <a href="full_faculty_info.aspx">
                        ...
                        <br/>
                        <p>
                            <span style="font-size: 18px">Dr. Herbert Harrsion</span><br/> (Head of Department)<br/> PhD Computer Engineering<br/> Date Of Joining : 01/08/2007<br/>
                            </p>
                    </a>
                </div>
                <div class="col-md-2 faculty">
